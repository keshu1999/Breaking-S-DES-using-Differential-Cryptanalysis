...
def main():
    ...
    for count in range(256):
        print('Checking plainext pair #',count+1, flush = True)
        ...
        for k in range(256):
            ...
            if(BitVector(bitstring = str(l1xor) + str(r1xor) ) == deltavRnd1):
                ...
                print("Key Match Found..", flush = True)
                # print("key : ",k," : ",k2)
    ...
    if(bestkey >= 0):
        ...
        print("Best found subkey for round 2 : ",bs)
    else :
        print("Best found subkey for round 2 : ",bestkey)
